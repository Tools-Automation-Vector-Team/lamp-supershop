						...
						<div class="row">
							...
							<div class="col-lg-5 col-md-6">
								<div class="widget widget-newsletter">
									...
									<p>
										<ol>
											<li style="color:red">This website has been created for testing purposes for Vector</li>
											<li> Please note that the content is subject to change during the testing phase.</li>
											<li> This is not a real selling site and no actual transactions will take place.</li>
</ol>
									</p>
								</div>
							</div>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank"> Telemetrics Tech</a>
						</p>
